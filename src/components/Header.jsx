      ...
      <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} sm:hidden`} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <div className='flex flex-col'>
                <button className='w-28 h-9 rounded-lg shadow-md shadow-black bg-orange-500 font-semibold font-poppins mr-5 mb-3 sm:mb-0 '><Link to="/portfolio">Portfolio</Link></button>
                <button className='w-28 h-9 rounded-lg shadow-md shadow-black bg-orange-500 font-semibold font-poppins '><Link to= "/contact"> Contact Me</Link></button>
          </div>
        </div>
      </div>
